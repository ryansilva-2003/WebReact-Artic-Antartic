...
A plataforma busca conscientizar sobre a importância dos polos para o equilíbrio climático do planeta, além de evidenciar os impactos das mudanças climáticas nesses ambientes sensíveis. Por meio de uma navegação simples e intuitiva, o usuário pode explorar dados, curiosidades e informações relevantes sobre cada região.</p></div>
        </section>
    )
}
